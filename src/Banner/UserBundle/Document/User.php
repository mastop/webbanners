...
/** @ODM\Document (
 * collection="user",
 * repositoryClass="Banner\UserBundle\Document\UserRepository"
 * ) 
 */
class User implements UserInterface {
     ...
     * 
     * @ODM\EmbedOne(targetDocument="Banner\UserBundle\Document\BankData")
     */
    protected $bankData;
     ...
     * Set bankData
     *
     * @param Banner\UserBundle\Document\BankData $bankData
     */
    public function setBankData(\Banner\UserBundle\Document\BankData $bankData)
    {
     ...
     * Get bankData
     *
     * @return Banner\UserBundle\Document\BankData $bankData
     */
     ...
     * Set father
     *
     * @param Banner\UserBundle\Document\User $father
     */
    public function setFather(\Banner\UserBundle\Document\User $father)
    {
        $this->father = $father;
    }
     ...
     * Get father
     *
     * @return Banner\UserBundle\Document\User $father
     */
