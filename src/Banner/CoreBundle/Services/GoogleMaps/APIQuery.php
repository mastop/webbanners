<?php
namespace Banner\CoreBundle\Services\GoogleMaps;

use Banner\CoreBundle\Services\GoogleMaps\Service\Result;
use Banner\CoreBundle\Services\GoogleMaps\Service\QueryAbstract;
...
class APIQuery extends QueryAbstract
{
    ...
    /**
* @return Banner\CoreBundle\Services\GoogleMaps\Service\Result
*/
