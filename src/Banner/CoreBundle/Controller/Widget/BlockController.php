 ...
 *                                                                 88           
 * 
 * Banner/CoreBundle/Controller/Widget/BlockController.php
 *
...
namespace Banner\CoreBundle\Controller\Widget;
...
class BlockController extends BaseController {
    ...
    public function renderAction($area = 'home', $opts = array()) {
        ...
        //$c++;
        //$ret[$c]['widget'] = 'BannerCoreBundle:Widget\\Block:facebookFans';
        ...
        //$ret[$c]['widget'] = 'BannerCoreBundle:Widget\\Block:facebook';
    ...
    {
        $session = $this->get('session');
        $banner = $this->mongo('BannerCoreBundle:Banner')->findByCity($this->mastop()->param('core.banner.loadnum'), $session->get('banner.user.cityId'));
