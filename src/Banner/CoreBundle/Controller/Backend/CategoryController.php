...
use Banner\CoreBundle\Form\CategoryType;
...
*/
    public function indexAction() {
        ...
        $categorias = $this->mongo('BannerCoreBundle:Category')->findAllByOrder();
        return array(
...
*/
    public function categoryAction($slug = null) {
        ...
        if ($slug) {
            $cat = $this->mongo('BannerCoreBundle:Category')->findOneBy($query);
            if (!$cat)
...
*/
    public function deleteAction($id) {
        ...
        $request = $this->get('request');
        $dm = $this->dm();
        $cat = $this->mongo('BannerCoreBundle:Category')->find($id);
