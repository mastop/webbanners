...
/**
 * Banner/CoreBundle/Controller/Backend/ContentController.php
 *
...
use Banner\CoreBundle\Form\ContentType;
...
class ContentController extends BaseController
{
    ...
    {
        $content = $this->mongo('BannerCoreBundle:Content')->findAllByCreated();
