...
namespace Tuvais\UserBundle\Controller\Backend;
...
class UserController extends BaseController {
    ...
    public function indexAction() {
        ...
        $dados = $rep->getRepository("TuvaisUserBundle:User")->findAllByCreated();
        $itens = array();
        $titulo = $this->trans("Listagem de usuários");

        return $this->render('TuvaisUserBundle:Backend/User:index.html.twig', array(
                    'title' => $titulo,
                    'usuarios' => $dados));
    }
    ...
    public function passAction($username) {
        ...
        return $this->render('TuvaisUserBundle:Backend/User:senha.html.twig', array(
    ...
    public function infoAction(User $user){
        ...
        $ofertas = $this->mongo('TuvaisDealBundle:Deal')->count('user.id', $user->getId());
        $compras = $this->mongo('TuvaisOrderBundle:Order')->count('user.id', $user->getId());
        $vendas = $this->mongo('TuvaisOrderBundle:Order')->count('seller.id', $user->getId());
        $saldo = $this->mongo('TuvaisOrderBundle:Escrow')->totalCheckoutByUser($user->getId());
        return array(
            'title' => $title,
            'user' => $user,
            'ofertas' => $ofertas,
