...
class BannerController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        $banner = $this->mongo('TuvaisCoreBundle:Banner')->findAll();
        return array(
            'banner'  => $banner,
            'title'   => $title,
    ...
    public function bannerAction($id = null, $control = false)
    {
        ...
        if($id){
            $banner = $this->mongo('TuvaisCoreBundle:Banner')->find($id);
        ...
        if('POST' == $request->getMethod()){
            ...
            if($fileData['logo'] != null){
                ...
                $file->setPath($this->get('kernel')->getRootDir() . "/../web/uploads/tuvaiscore/banner");
    ...
    public function ajaxAction()
    {
        if ($this->get('request')->isXmlHttpRequest()) {
            if ($this->get('request')->getMethod() == 'GET') {
                ...
                $qb = $this->mongo('TuvaisUserBundle:User')->createQueryBuilder();
