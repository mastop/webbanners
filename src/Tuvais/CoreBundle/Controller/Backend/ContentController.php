...
/**
 * Tuvais/CoreBundle/Controller/Backend/ContentController.php
 *
...
use Tuvais\CoreBundle\Form\ContentType;
...
class ContentController extends BaseController
{
    ...
    {
        $content = $this->mongo('TuvaisCoreBundle:Content')->findAllByCreated();
